...
# Trả về True nếu điểm từ 0 đến 10.
...
# Yêu cầu nhập điểm cho đến khi hợp lệ
...
def update_score(student_list):
    ...
    student_index = find_student_by_id(
        student_list,
        student_id
    )
    ...
    student_list[student_index]["math_score"] = math_score
    student_list[student_index]["english_score"] = english_score
