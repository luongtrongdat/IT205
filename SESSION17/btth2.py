...
def update_student():
    ...
    print(f"Cập nhật điểm cho sinh viên: {student['name']}")
    ...
    student["rank"] = classify_student(student["average"])
...
def search_student():
    ...
    if choice == "1":
        ...
        keyword = input("Nhập tên cần tìm: ").lower().strip()
...
def reclassify_all():
    ...
    print("Đã phân loại lại toàn bộ sinh viên!")
